...
import { Apple, Palette, Edit, Calculator, Worm, Folder, MessageCircle, Puzzle } from "lucide-react"
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
const menuItems = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: "Puzzle", action: "slidingPuzzle", icon: <Puzzle className="w-4 h-4 mr-2" /> },
            "-",
